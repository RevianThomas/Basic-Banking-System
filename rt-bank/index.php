...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-md" id="nav">
      <a class="navbar-brand" href="index.php">RT BANK</a>
            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                    <img src="img/rtbank.png" class="img-fluid" width="100" height="100">
                  <h3>Welcome to</h3>
                  <h1>RT BANK</h1>
                </div>
              </div>
      ...
      <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    <img src="img/transfer.png" class="img-fluid" width="230" height="230">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>Intern @ Sparks Foundation<br>&copy 2021. Developed by <b>REVIAN THOMAS J</b>  </p>
      </footer>
